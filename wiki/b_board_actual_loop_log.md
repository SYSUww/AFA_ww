...
- 外部基线：提交 006，94%，`fc_b_003=ABCD`
- 方向：对剩余 93 道未变题做“未选项完整检索 + 产品/主体绑定 + 原文直接蕴含”审计
- 状态：`official_score_97`，相对 94% 基线净提升 3 题

### 候选变化

| qid | 94%基线 | 候选 | 原因 |
|---|---|---|---|
| `fc_b_019` | `BD` | `ABCD` | 长安银行原文分别直接支持信用风险、流动性风险、董事会治理和三道防线，A/C 为漏选 |
| `ins_b_006` | `CD` | `BCD` | 营运交通工具意外险明确列出恐怖袭击，B 为漏选；完整清单排除 A |
| `ins_b_012` | `BD` | `BCD` | 众安家庭财产综合险明确列出地震、海啸，C 为漏选；完整清单排除 A |
| `ins_b_016` | `BD` | `ABD` | 国寿增益宝明确包含两年内自杀但无民事行为能力人除外，A 为漏选；完整清单排除 C |
| `ins_b_017` | `AD` | `ABCD` | 四个产品均有核风险免责原文，B/C 为漏选 |

### 失败尝试与修复

- 第一轮 `ins_b_006` 固定评测仅 30/blocked：D 误选“恐怖活动”释义，A 只展示免责第 3 至 7 项，证据闭环不完整。
- 修复为逐 clause term group 强制命中，并为 D 强制检索“下列原因造成的损失、保险人不负责赔偿、恐怖活动”同段原文；修复后为 97/high，独立答案 `BCD`。
- 第一轮 `fc_b_019` 的 D 仍调用模型；原因是三道防线原文跨两个 chunk，单一 required group 无法同时命中。拆成第一/二道防线与第三道防线两个定向证据组后，四项均走确定性规则，生成 token 为 0。

### 固定评测与验证

- GPT-5.6 固定评测：`fc_b_019=97`、`ins_b_006=97`、`ins_b_012=100`、`ins_b_016=100`、`ins_b_017=99`，独立答案均与候选一致。
- 评测哨兵：7/7 通过；评测失败：0。
- 回归测试：90/90 通过（retrieval integrity + B榜回归 + 固定评测链路）。
- 最终组合覆盖：100/100；提交格式校验通过。
- 相对 94% 基线只改变上述 5 个 qid，其他 95 题答案字段不变。

### 待提交产物

- 目录：`artifacts/b_board_actual/candidates/i024_remaining93_p0/official94_plus_direct_source_five_v1`
- 文件：`submit.csv`
- SHA-256：`497658e3e76c0df3bb28134a4d1b2d442bb5b5602ea4654d7d0ce019aecb400d`
- 预期信息增益：若官网 94%→99%，在 100 题等权完全匹配前提下，可确认 5 题均由错改对；否则根据净变化决定拆分回滚。
- 剩余风险：即使达到 99%，仍有 1 道未定位错误；官方结果优先于固定评测置信度。

### 官网结果回填

- 用户反馈提交 007 平台准确率为 **97%**，相对提交 006 的 94% 提升 3 个百分点。
- 固定评测对 5 题全部给出 97–100 高置信，但官网只净增 3，说明内部评测仍无法可靠处理其中至少 1–2 道题的完整选项口径。
...
- recorded_at: `2026-07-22T19:52:20+00:00`

```json
{
  "approach": "先读历史日志后运行v10完整research链，答案求解阶段不读取97%参考答案。",
  "artifacts": {
    "run_manifest": "/Users/abandon/Documents/AFA_ww/artifacts/b_board_score_loop/full_chain_e08e737_research_v1/run_manifest.json"
  },
  "base_commit": "e08e73768384dd89b8fafe69be8e4ecdcf363d41",
  "candidate_fingerprint": {
    "components": {
      "context": {
        "base_commit": "e08e73768384dd89b8fafe69be8e4ecdcf363d41",
        "code_hash": "5c54296a1b1c177a9427b18cf27b359ea6f4c56e320cd27adf38078dccff6cda",
        "evaluator_model": "gpt-5.6",
        "evaluator_version": "b_reasoning_judge_v1_new_md",
        "generator_model": "gpt-5.5"
      },
      "identity": {
        "change_vector": {
          ...
          "reference": "official97_incumbent",
          "run_mode": "research",
          "runner": "b_actual_v10_reasoning_audit"
        },
        "domains": [],
        "hypothesis": "当前v10 research链应能完整生成100题、reasoning和逐调用usage，并量化对97% incumbent的伪标签一致率",
        "pipeline_stage": "runtime",
        "question_types": [],
    ...
    "context_sha256": "f56bd5861383f18d08e605aa5892c0c4e6702902f4d35f81a55473057ee76188",
    "direction_sha256": "910076fe66c7f2d33e159fa9a2c3fa1aac879822187cffcc51781599a5ea2845",
    "schema_version": 1,
    "semantic_sha256": "72af82dd9a8059a0c07dbe5771f687b900cb8a6fcf05061a78237b76520f5eb8",
    "sha256": "76ac44feb29285978824f607829a2ad24f087a15a5645c051b7d201b37d14fa5"
  },
  "change_vector": {
    "answers_not_exposed_to_solver": true,
    "reference": "official97_incumbent",
  ...
  "code_hash": "5c54296a1b1c177a9427b18cf27b359ea6f4c56e320cd27adf38078dccff6cda",
  "direction_id": "full_chain_reproduction_baseline_v10",
  "effect": "完成98/100题，尚不能形成可比全量结果。",
  "evaluator_model": "gpt-5.6",
  "evaluator_version": "b_reasoning_judge_v1_new_md",
  "experiment_id": "b-loop-full-chain-reproduction-baseline-v10",
  "failure_analysis": "失败qid: ['fin_b_017', 'res_b_005']",
  "generator_model": "gpt-5.5",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "cf5048c690593f119e3f6349612dc824ec5d8c96ba6fadc584106c73c7b2d580",
      "size": 483426
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "030f06443d52d5e6aaf001d7e0abe782849c71615ec3d6c6b546b545c471bd20",
      "size": 390501
    },
    "related_log_sections": [
      "b0-run-integrity-reg016-v2",
    ...
    "reviewed_at": "2026-07-22T19:37:59+00:00"
  },
  "hypothesis": "当前v10 research链应能完整生成100题、reasoning和逐调用usage，并量化对97% incumbent的伪标签一致率",
  "material_delta": {
    "end_to_end_reasoning_and_usage": true
  },
  "metrics": {
    "answered_question_count": 98,
    "comparable": false,
    "failed_qids": [
      "fin_b_017",
      "res_b_005"
  ...
  "next_step": "修复技术失败并原目录安全续跑；技术失败不消耗三轮可比尝试。",
  "pipeline_stage": "runtime",
  "recorded_at": "2026-07-22T19:52:20+00:00",
  "registry_schema_version": 1,
  "root_cause_cluster": "end_to_end_reproducibility",
...
- recorded_at: `2026-07-22T19:59:51+00:00`

```json
{
  "approach": "在CalculationExecutor中显式执行百分数点单位代数：百分数÷百分数同时转为ratio，金额×百分数先除100；兼容模型常见的具名args对象和带%数值。先以8题真实生成链验证。",
  "artifact_path": "artifacts/b_board_score_loop/calculation_unit_semantics_a1_target8",
  "base_commit": "ae9b06e688cd20eac4592e348d64363051647d90",
  "candidate_fingerprint": {
    "components": {
      "context": {
        "base_commit": "ae9b06e688cd20eac4592e348d64363051647d90",
        "code_hash": "41e382311ffdce695062114232704b44d009f52eb28493148e72df4c862c6693",
        "evaluator_model": "gpt-5.6",
        "evaluator_version": "b_reasoning_judge_v1_new_md",
        "generator_model": "gpt-5.5"
      },
      "identity": {
        "change_vector": {
          "mul_percent_points": "convert_operand_to_ratio",
          "named_argument_objects": [
            "div",
            "abs",
            "pct_change",
            "pct_point_delta"
          ],
          "percent_points_div_percent_points": "convert_both_then_ratio",
          "percent_suffix_normalization": true,
          "variant": "a1"
        },
        "domains": [
          "financial_reports",
        ...
        "hypothesis": "百分数点参与除法和乘法时进行显式单位消去，可一次修复6个100倍量级错误，并让2个等价具名参数计划成功重放",
        "pipeline_stage": "calculation",
        "question_types": [
          "calculation"
        ],
    ...
    "context_sha256": "651c8ab1d9274301599580dbca18d89e4334627204d51c2ed7ad7cb06ff31272",
    "direction_sha256": "ad93d0ce6ddc10a16b41a05159ecf4946e520ea60e2dad5d2051d689ae32d2a8",
    "schema_version": 1,
    "semantic_sha256": "c9a4df9b3b446d93ae69795f6c279e6b5d734561dbfd6e19590a1c9a70c2dcd4",
    "sha256": "97efa9f23b78dffd907c73eb5a3a87d60aebfa8f9e54cf3db110d16fa3a441c1"
  },
  "change_vector": {
    "mul_percent_points": "convert_operand_to_ratio",
    "named_argument_objects": [
  ...
  "effect": "目标集完成8/8，伪标签一致7/8。",
  "evaluator_model": "gpt-5.6",
  "evaluator_version": "b_reasoning_judge_v1_new_md",
  "experiment_id": "b-loop-calculation-percent-unit-semantics-a1-target8",
  "failure_analysis": "仍失败或不一致：failed=[], mismatch=['fin_b_017']",
  "generator_model": "gpt-5.5",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "180c74d7463ac84ed8f9392894623ed82ce2ff2b00203f3643f8871d0b2b4fcf",
      "size": 490359
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "331722f412146f08178219cb41e3bb1380e566ce04f748028c96b7611d613c9c",
      "size": 396247
    },
    "related_log_sections": [
      "B0-actual-integrity",
    ...
    "reviewed_at": "2026-07-22T19:57:29+00:00"
  },
  "hypothesis": "百分数点参与除法和乘法时进行显式单位消去，可一次修复6个100倍量级错误，并让2个等价具名参数计划成功重放",
  "material_delta": {
    "unit_algebra": "percent_points_are_not_implicit_scalars"
  },
  "metrics": {
    "answer_by_qid": {
      "fin_b_017": [
    ...
    "answered_count": 8,
    "baseline_pseudo_matches": 0,
    "comparable_scope": "target8_only_not_global",
    "failed_qids": [],
    "generation_token_total_including_failed": 172827,
    "pseudo_match_rate": 87.5,
    "pseudo_matches": 7,
    "reasoning_aggregate": {
      "dimension_means": {
        "clarity": 94.625,
      ...
      "p10": 75.33333333333333,
      "question_count": 8,
      "reasoning_score": 92.54166666666667,
      "status_counts": {
        "scored": 8
      },
      "zero_score_count": 0
    ...
    "submission_token_total": 172827,
    "target_count": 8,
    "target_scorecard": {
      "accuracy_score": 87.5,
      "accuracy_source": "target8_pseudo_match_to_official97_incumbent_not_ground_truth",
      ...
      "reasoning_score": 92.54166666666667,
      "token_efficiency_score": 34.565400000000004,
      "token_total": 172827,
      "total_score": 77.92141333333333
    }
  },
  "next_step": "分析剩余失败；本方向最多再尝试2个material variant。",
  "pipeline_stage": "calculation",
  "question_types": [
    "calculation"
  ],
...
- recorded_at: `2026-07-22T20:03:31+00:00`

```json
{
  "approach": "保留A1单位代数，并在计算Prompt中明确执行器自动处理百分数，禁止100%辅助基数和手工重复乘除100；以同一8题真实链复测。",
  "artifact_path": "artifacts/b_board_score_loop/calculation_unit_semantics_a2_prompt_contract_target8",
  "base_commit": "ae9b06e688cd20eac4592e348d64363051647d90",
  "candidate_fingerprint": {
    "components": {
      "context": {
        "base_commit": "ae9b06e688cd20eac4592e348d64363051647d90",
        "code_hash": "19c7199a20c4e4bfc10e2d8889d9d4cb9ed47a3eead141f8b02768fe25073176",
        "evaluator_model": "gpt-5.6",
        "evaluator_version": "b_reasoning_judge_v1_new_md",
        "generator_model": "gpt-5.5"
      },
      "identity": {
        "change_vector": {
          "executor_rules": "a1",
          "prompt_contract": "forbid_manual_percent_base_and_duplicate_scaling",
          "variant": "a2"
        },
        "domains": [
          "financial_reports",
        ...
        "hypothesis": "在a1显式单位代数基础上，把执行器自动缩放契约告知结构化求解器，可消除fin_b_017重复乘100且保持其余7题稳定",
        "pipeline_stage": "calculation",
        "question_types": [
          "calculation"
        ],
    ...
    "context_sha256": "e830b3ef6b8a511ffe635e263db4997eebe872cece6ac5cdf529190a14370daa",
    "direction_sha256": "196dc8d91e4fd2e53ef8c3fd455e069843ca64c321d113a8bea937b35eb03efa",
    "schema_version": 1,
    "semantic_sha256": "7c2d2794b1df309501b78676c069555faaae4146324f3f3b477ac7fd69ab3220",
    "sha256": "ceb1fb21414934709494f71b45e89782eaa2559a533691dac9700f4d16750765"
  },
  "change_vector": {
    "executor_rules": "a1",
    "prompt_contract": "forbid_manual_percent_base_and_duplicate_scaling",
  ...
  "effect": "完成8/8，伪标签一致8/8（A1为7/8）；reasoning均分93.21。",
  "evaluator_model": "gpt-5.6",
  "evaluator_version": "b_reasoning_judge_v1_new_md",
  "experiment_id": "b-loop-calculation-percent-unit-semantics-a2-prompt-contract-target8",
  "failure_analysis": "目标8题全部对齐97% incumbent伪标签，无技术失败；逐题伪标签仍非真实答案，需全量验证防止非目标计算题回归。",
  "generator_model": "gpt-5.5",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "d91e2fcd2484f6473b842dd9475dd2884032513d9051c622757323c9fb001d71",
      "size": 503989
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "fc3ddf7a0d773e42e0f4fe30c954ef2b46c20c7102fb7b24622911a666b28520",
      "size": 407141
    },
    "related_log_sections": [
      "b0-run-integrity-reg016-v2",
    ...
    "reviewed_at": "2026-07-22T20:01:11+00:00"
  },
  "hypothesis": "在A1显式单位代数基础上，把执行器自动缩放契约告知结构化求解器，可消除fin_b_017重复乘100且保持其余7题稳定",
  "material_delta": {
    "prompt_executor_contract_alignment": true
  },
  "metrics": {
    "a1_pseudo_matches": 7,
    "answer_by_qid": {
    ...
    "reasoning_aggregate": {
      ...
      "p10": 77.33333333333333,
      "question_count": 8,
      "reasoning_score": 93.20833333333333,
      "status_counts": {
        "scored": 8
      },
      "zero_score_count": 0
    ...
    "target_scorecard": {
      ...
      "reasoning_prompt_version": "b_reasoning_judge_v1_new_md",
      "reasoning_score": 93.20833333333333,
      "token_efficiency_score": 34.6122,
      "token_total": 173061,
      "total_score": 85.56410666666666
    }
  },
  "next_step": "运行233项全量测试；若通过则提交并推送该有效分支，再跑全100题research链和最终三维评分。",
  "pipeline_stage": "calculation",
  "question_types": [
    "calculation"
  ],
...
- recorded_at: `2026-07-22T20:45:32+00:00`

```json
{
  "approach": "冻结100题答案，仅对固定gpt-5.6基线低于90分的19条reasoning用gpt-5.5改写为定位、关键事实、推导、结论四步摘要；完整计入改写usage，再对100条reasoning重新评分。",
  "artifact_path": "artifacts/b_board_score_loop/reasoning_lowtail_structured_a1_lt90",
  "base_commit": "cdaa8d4764083da1f435e278605c62575f045ce9",
  "candidate_fingerprint": {
    "components": {
      "context": {
        "base_commit": "cdaa8d4764083da1f435e278605c62575f045ce9",
      ...
      "identity": {
        "change_vector": {
          ...
          "selection": "fixed_judge_score_lt_90",
          "variant": "a1"
        },
        "domains": [],
        "hypothesis": "仅重写固定judge低于90分的19题为定位-事实-推导-结论四步摘要，可在答案冻结和token满分不变下抬升p10与最终总分",
        "pipeline_stage": "reasoning",
        "question_types": [],
    ...
    "context_sha256": "9f9010ac37dcbd43dd6c1181679c8e723f958ac1e00bd934708fe0e290baeaab",
    "direction_sha256": "35904d436370d9769547d190a19f58e819ad1a7f3366cf87d577c666f082b5af",
    "schema_version": 1,
    "semantic_sha256": "bbe1c75fb8d8f40a75d3519d5a3eb6d50a3de33006a167e141813f2550985568",
    "sha256": "0bbfb59f8d9432c1d2a8114430fcc20462f8ba2c3f12af46c77fe408fe65cb57"
  },
  "change_vector": {
    "answer_freeze": true,
    "rewrite_prompt_version": "b_reasoning_rewrite_structured_v1",
  ...
  "domains": [],
  "effect": "reasoning 93.330→94.383（+1.053），p10 88.333→91.333，代理总分 98.666→98.877（+0.211），答案变化0。",
  "evaluator_model": "gpt-5.6",
  "evaluator_version": "b_reasoning_judge_v1_new_md",
  "experiment_id": "b-loop-reasoning-lowtail-explicit-structure-a1-lt90",
  "failure_analysis": "改写目标全部成功且总分/p10均提升；这是离线选低尾研究，正式全链不能依赖赛后judge选题，需要把有效结构前移到统一reasoning生成Prompt。",
  "generator_model": "gpt-5.5",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "876d2e5c57f4b340fdceb4f22dae71519d31098f84b576ed8c54f374b2e135d1",
      "size": 549154
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "fdc8a1116d7212ac04ed1864dcb0b08d0df52bc3d250bf883587ad542aaa367a",
      "size": 443881
    },
    "related_log_sections": [
      "b-loop-i023-gpt56-answer-error-audit-v2",
    ...
    "reviewed_at": "2026-07-22T20:43:37+00:00"
  },
  "hypothesis": "仅重写固定judge低于90分的19题为定位-事实-推导-结论四步摘要，可在答案冻结和Token满分不变下抬升p10与最终总分",
  "material_delta": {
    "targeted_lowtail_rewrite": true
  },
  "metrics": {
    "answer_changes": 0,
    ...
    "candidate_reasoning_aggregate": {
      ...
      "p10": 91.33333333333333,
      "question_count": 100,
      "reasoning_score": 94.38333333333334,
      "status_counts": {
        "scored": 100
      },
      "zero_score_count": 0
    ...
    "p10_delta": 3.0,
    "reasoning_score_delta": 1.0533333333333417,
    "rewrite_failure_count": 0,
    "rewrite_token_usage": {
      "completion_tokens": 5640,
      "prompt_tokens": 103259,
      "total_tokens": 108899
    },
    "rewritten_count": 19,
    "submission_token_usage": {
      "completion_tokens": 105139,
      "prompt_tokens": 1236981,
      "total_tokens": 1342120
    },
    "target_count": 19,
    "total_score_delta": 0.21066666666666833
  },
  "next_step": "A2把四步结构和显式最终答案/排除项要求前移到全链reasoning生成Prompt，并以代表性低尾题真实生成验证。",
  "pipeline_stage": "reasoning",
  "question_types": [],
  "recorded_at": "2026-07-22T20:45:32+00:00",
  "registry_schema_version": 1,
...
- recorded_at: `2026-07-22T22:08:03+00:00`

```json
{
  "approach": "针对A2仍退化的res_b_008冻结答案；gpt-5.5反馈若仅有一个仍需验证的完整性缺口，保留原摘要以避免引入无直接证据的断言，并计入反馈API usage。",
  "artifact_path": "artifacts/b_board_score_loop/reasoning_self_refine_a3_conservative_gate",
  "base_commit": "018502c838c204ae3a4a2d11855066ba2ebd4c38",
  "candidate_fingerprint": {
    "components": {
      "context": {
        "base_commit": "018502c838c204ae3a4a2d11855066ba2ebd4c38",
        "code_hash": "94afa83e64c7f410c3069dbf1874e2e565d0e63d4c54084014733c5873c41129",
        "evaluator_model": "gpt-5.6",
        "evaluator_version": "b_reasoning_judge_v1_new_md",
        "generator_model": "gpt-5.5"
      },
      "identity": {
        "change_vector": {
          "answer_freeze_gate": true,
          "feedback_prompt_version": "b_submission_reasoning_feedback_v2_prioritized",
          "refine_policy_version": "b_submission_reasoning_refine_policy_v3_conservative",
          "refine_prompt_version": "b_submission_reasoning_refine_v2_minimal_verified",
    ...
    "context_sha256": "afebd1d14e222421f23719bb6ba1d2acbe5c64b1b04071e65dad6f781a7dda61",
    "direction_sha256": "3686b0f371a53f0e52226587d31eba23e30610a8579d9e8c47055a572a4cc311",
    "schema_version": 1,
    "semantic_sha256": "c8ca4e034544aee8709792167e0945e85f0460fc191d5a866e431bd297333e86",
    "sha256": "f298e7e57ac11700abe1e51d0dc67075d6e3221d1bce027f726c74c838a0b738"
  },
  "change_vector": {
    "answer_freeze_gate": true,
    "feedback_prompt_version": "b_submission_reasoning_feedback_v2_prioritized",
  ...
  "direction_id": "reasoning_self_refine_verification",
  "domains": [],
  "effect": "目标1题reasoning 91.000→92.667（+1.667）；相对A2全100题因果代理总分 99.238667→99.242000（+0.003333），答案变化0。",
  "evaluator_model": "gpt-5.6",
  "evaluator_version": "b_reasoning_judge_v1_new_md",
  ...
  "history_review": {
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "2d2006b3bd02c14eb8178716db37cee06ef44c70c0940343913a0c8315c56f57",
      "size": 691281
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "ad80bc1032ff3216429fdbe6421087c224330952ae2caa4afbecd62ed9422c98",
      "size": 560523
    },
    "related_log_sections": [
      "b-loop-i023-gpt56-answer-error-audit-v2",
    ...
    "reviewed_at": "2026-07-22T22:07:31+00:00"
  },
  "hypothesis": "仅有一个完整性疑问且需要进一步验证时保留原摘要，可避免在证据不足时引入新断言并消除A2剩余退化",
  "material_delta": {
    "conservative_actionability_gate": true
  },
  "metrics": {
    "amount_scale_replacement_run": "artifacts/b_board_score_loop/amount_scale_a1_res_b012",
    "answer_changes": {},
    ...
    "baseline_scorecard": {
      "accuracy_score": 100.0,
      "reasoning_score": 96.19333333333334,
      "token_efficiency_score": 100.0,
      "token_total": 1285840,
      "total_score": 99.23866666666667
    },
    "candidate_scorecard": {
      "accuracy_score": 100.0,
      "reasoning_score": 96.21,
      "token_efficiency_score": 100.0,
      "token_total": 1277002,
      "total_score": 99.242
    },
    ...
    "target_reasoning_after": 92.66666666666667,
    "target_reasoning_aggregate": {
      "dimension_means": {
        "clarity": 89.0,
        "completeness": 92.0,
      ...
      "p10": 91.33333333333333,
      "question_count": 1,
      "reasoning_score": 91.33333333333333,
      "status_counts": {
        "scored": 1
      },
      "zero_score_count": 0
    },
    "target_reasoning_before": 91.0,
    "target_reasoning_delta": 1.6666666666666714,
    "total_score_delta": 0.0033333333333303017
  },
  "next_step": "运行全量单测并提交推送有效分支；本方向已达3轮上限，随后封盘。",
  "pipeline_stage": "reasoning",
  "question_types": [],
  "recorded_at": "2026-07-22T22:08:03+00:00",
  "registry_schema_version": 1,
...
- recorded_at: `2026-07-22T22:09:13+00:00`

```json
{
  "approach": "重放A1、A2的逐题因果归一规则：A2中fc_b_007文本未变，累计到A3时继续使用原密封分91.667；再用A3未变的res_b_008原密封分92.667替换。",
  "artifact_path": "artifacts/b_board_score_loop/reasoning_self_refine_a3_conservative_gate",
  "base_commit": "018502c838c204ae3a4a2d11855066ba2ebd4c38",
  "candidate_fingerprint": {
    "components": {
      ...
      "identity": {
        "change_vector": {
          "corrected_experiment": "b-loop-reasoning-self-refine-verification-a3-conservative-gate",
          "restore_incumbent_causal_normalization": true
        },
        "domains": [],
        "hypothesis": "累计组合必须继承前序实验对未改变文本的因果归一分，不能重新引入当次judge漂移",
        "pipeline_stage": "evaluation",
        "question_types": [],
        "root_cause_cluster": "causal_reasoning_score_accumulation",
        "target_qids": [
          "fc_b_007",
          "res_b_008"
        ]
    ...
    "context_sha256": "f650e5e808d233bf22c64befd2563d76f97598b1ef3e8276ac3db0865a0c071a",
    "direction_sha256": "615d1afcd906f203de7c3246a751d9c9e77e81b35918dd722e13000c1d1715ce",
    "schema_version": 1,
    "semantic_sha256": "3763b23727284ee1323164c442a36f9fed5fde6adb17d167dd9dbeb9c9b9245b",
    "sha256": "8d539b65d1413c1acdb0e1b664358a9f1ab00a258f6e9ee4a0fd03cbdb7bf8d8"
  },
  "change_vector": {
    "corrected_experiment": "b-loop-reasoning-self-refine-verification-a3-conservative-gate",
    "restore_incumbent_causal_normalization": true
  },
  "direction_id": "metric_scope_correction_reasoning_self_refine_a3",
  "effect": "A3基线总分99.238667更正为99.238000，候选99.242000更正为99.241333；增量仍为+0.003333，有效性结论不变。",
  "evaluator_model": "gpt-5.6",
  "evaluator_version": "b_reasoning_judge_v1_new_md",
  "experiment_id": "b-loop-metric-correction-reasoning-self-refine-a3-cumulative-normalization",
  "failure_analysis": "旧脚本读取A2原始judge行覆盖了A2 causal_composite中对未变fc_b_007的归一分；影响绝对值，不影响A3相对增量。",
  "generator_model": "gpt-5.5",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "c4d015fdb08584c8c48d3f60dc0ef28604fde4eb9b8683e0d1b6a3b61b5afe7d",
      "size": 703650
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "41d5a8b7eb4a5c173003981b51d63d624e484d4dd97d81e2044ed43d5dc84366",
      "size": 571024
    },
    "related_log_sections": [
      "b-loop-calculation_executor-a3-directional-operands-v3",
    ...
    "reviewed_at": "2026-07-22T22:09:13+00:00"
  },
  "hypothesis": "累计组合必须继承前序实验对未改变文本的因果归一分，不能重新引入当次judge漂移",
  "material_delta": {
    "metric_correction_only": true
  },
  "metrics": {
    "a3_effective_after_correction": true,
    "corrected_baseline_scorecard": {
      "accuracy_score": 100.0,
      "reasoning_score": 96.19,
      "token_efficiency_score": 100.0,
      "token_total": 1285840,
    ...
    "corrected_candidate_scorecard": {
      "accuracy_score": 100.0,
      "reasoning_score": 96.20666666666666,
      "token_efficiency_score": 100.0,
      "token_total": 1277002,
      "total_score": 99.24133333333333
    },
    "corrected_total_delta": 0.0033333333333303017,
    "incorrect_baseline_total": 99.23866666666667,
    "incorrect_candidate_total": 99.242
  },
  "next_step": "使用修正后的累计归一代码构建最终100题研究候选；A3方向按3轮上限封盘。",
  "pipeline_stage": "evaluation",
  "recorded_at": "2026-07-22T22:09:13+00:00",
  "registry_schema_version": 1,
  "root_cause_cluster": "causal_reasoning_score_accumulation",
...
- recorded_at: `2026-07-22T22:11:06+00:00`

```json
{
  "approach": "以full_chain_82d4492为底座，依次覆盖res_b_012金额尺度修复、reasoning self-refine A1/A2/A3逐题产物，重算100题usage与因果reasoning分，并用新版writer/validator执行audit_ready校验。",
  "artifact_path": "artifacts/b_board_score_loop/final_composite_i030_reasoning_self_refine",
  "base_commit": "018502c838c204ae3a4a2d11855066ba2ebd4c38",
  "candidate_fingerprint": {
    "components": {
      "context": {
      ...
      "identity": {
        "change_vector": {
          "audit_ready_validation": true,
          "overlay_order": [
            "amount_scale_a1",
            "reasoning_self_refine_a1",
            "reasoning_self_refine_a2",
            "reasoning_self_refine_a3"
          ]
        },
        "domains": [],
        "hypothesis": "将金额修复与三轮reasoning产物按因果顺序合成，可得到逐题usage真实、字段完整且可审计的100题研究候选",
        "pipeline_stage": "integration",
        "question_types": [],
        "root_cause_cluster": "full100_candidate_audit",
        "target_qids": []
      }
    },
    "context_sha256": "f650e5e808d233bf22c64befd2563d76f97598b1ef3e8276ac3db0865a0c071a",
    "direction_sha256": "63919abc021163c3eb3c9d8f47e401f54193e9a528e8690c5ccc18dfb1b44181",
    "schema_version": 1,
    "semantic_sha256": "4f67059e09e8bd6bcbaf87281cd66f904ecede82895699df2826831375b09442",
    "sha256": "31ba8bcd28df17dc95f22481aaf413b1c1cb45533ab145ac0a9b4d97101a564a"
  },
  "change_vector": {
    "audit_ready_validation": true,
    "overlay_order": [
  ...
  "direction_id": "final_composite_i030_materialization",
  "effect": "生成100题研究CSV；答案相对97%基准变化0，Token=1277002、reasoning=96.206667、代理总分=99.241333，summary与逐题字段校验通过。",
  "evaluator_model": "gpt-5.6",
  "evaluator_version": "b_reasoning_judge_v1_new_md",
  "experiment_id": "b-loop-final-composite-i030-materialization-audit",
  "failure_analysis": "当前模型保持gpt-5.5，非new.md允许的Qwen3.5/3.6；该文件只能用于研究和后续白名单模型复现，不能直接官网提交。97%也只是整份提交的官网准确率，逐题伪标签并非真值。",
  "generator_model": "gpt-5.5",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "9d1e98b003f822676f42d67dae257c26c78398a35cabf7d5ec248210c6a732bf",
      "size": 714245
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "38c7db78e82fbab2a272f7d9033871cfe6bd06cd420ca5db53e5b47be703dde6",
      "size": 580065
    },
    "related_log_sections": [],
    "reviewed_at": "2026-07-22T22:11:06+00:00"
  },
  "hypothesis": "将金额修复与三轮reasoning产物按因果顺序合成，可得到逐题usage真实、字段完整且可审计的100题研究候选",
  "metrics": {
    "answer_change_count": 0,
    ...
    "base_run": "artifacts/b_board_score_loop/full_chain_82d4492_research_v1",
    "generator_model": "gpt-5.5",
    "incumbent_submission": "artifacts/b_board_actual/candidates/i024_remaining93_p0/official94_plus_direct_source_five_v1/submit.csv",
    "overlay_qids": {
    ...
    "submission_model_allowlisted": false,
    "token_total": 1277002
  },
  "next_step": "全量测试、检查分支与远端一致性并推送A3；后续若要官网提交，需用白名单Qwen复现并重新记录全部原始usage。",
  "pipeline_stage": "integration",
  "recorded_at": "2026-07-22T22:11:06+00:00",
  "registry_schema_version": 1,
  "root_cause_cluster": "full100_candidate_audit",
...
- recorded_at: `2026-07-23T15:19:37+00:00`

```json
{
  "approach": "在已推送commit 692b239上，以submission模式、workers=1、固定qwen3.7-plus-2026-05-26独立运行fc_b_019与fc_b_001，不注入pseudo99答案，不上传官网；保留成功和失败调用的全部原始usage。",
  "artifact_path": "artifacts/b_board_actual/qwen37_probe_fc019_fc001_v1",
  "candidate_fingerprint": {
    "components": {
      "context": {},
      "identity": {
        "change_vector": {
          ...
          "prompt_version": "b_submission_reasoning_v3_qwen37_grounded",
          "scope": "two_qids"
        },
        "domains": [
          "financial_contracts"
        ],
        "hypothesis": "固定qwen3.7快照先跑一题多选和一题计算，可在低成本下验证json、计算重放、grounded reasoning与raw usage完整性。",
        "pipeline_stage": "qwen37_paid_probe",
        "question_types": [
          "calculation",
          "multi"
        ],
        "root_cause_cluster": "qwen37_runtime_compatibility_unknown",
        "target_qids": [
          "fc_b_001",
          "fc_b_019"
        ]
    ...
    "context_sha256": "44136fa355b3678a1146ad16f7e8649e94fb4fc21fe77e8310c060f61caaff8a",
    "direction_sha256": "4a84aa56902b1fb848035f26bfbce9191dc185355eccaa9444f9a13e1131f860",
    "schema_version": 1,
    "semantic_sha256": "8c71aaa27bb3ade9f1db77f5e0243704fed7428875b7811f40b7bb61e1c09902",
    "sha256": "98a7c0b6dd27aed835875a30c3dfb4119d63fb75e8a987ca210d63235f7071da"
  },
  "change_vector": {
    "model": "qwen3.7-plus-2026-05-26",
    "prompt_version": "b_submission_reasoning_v3_qwen37_grounded",
  ...
  "direction_id": "qwen37_two_question_submission_probe",
  "domains": [
    "financial_contracts"
  ],
  "effect": "fc_b_019成功，答案ABCD与官网答案锁一致，grounded reasoning一次生成成功；fc_b_001连续3次计算计划均因把百分数字面量声明为value_type=text而无法本地decimal重放，run为incomplete且没有submit.csv。全部调用共33812 Token，未漏记。",
  "experiment_id": "b-loop-qwen37-two-question-submission-probe-a1",
  "failure_analysis": "Qwen三次都输出value=5.55%、value_type=text、unit=%，而numeric percent2输出要求decimal；现有prompt没有给出百分数变量的明确JSON正例，错误反馈又触发无意义扩检索，导致同类结构错误重复三次。证据与目标数值本身正确，不是检索badcase。",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
        "context": {},
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "19b6b6aae84a180edfd4d73fb8542e60a10f7a9dfedd9a6169f32dc549e37e49",
      "size": 924491
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "32d9fe3a269c60c996ecb28c27a895643b1fabedbdf9885885a388af608b0827",
      "size": 749635
    },
    "related_log_sections": [
      "B0-actual-evaluation",
    ...
    "reviewed_at": "2026-07-23T15:19:37+00:00"
  },
  "hypothesis": "固定Qwen3.7快照先跑一题多选和一题计算，可在低成本下验证JSON、计算重放、grounded reasoning与raw usage完整性。",
  "metrics": {
    "answered_question_count": 1,
    ...
    "failure_class": "calculation_plan_numeric_value_typed_as_text",
    "fc_b_019_answer": [
      "ABCD"
    ],
    "fc_b_019_reference_match": true,
    "official_submission_count": 0,
    "prompt_tokens": 25832,
    "raw_call_count": 4,
  ...
  "next_step": "新增百分数字面量的明确prompt约束，并在执行前对“text型纯数字/百分号且被numeric output直接引用”的变量做可审计确定性decimal规范化；补单测后使用新run目录重跑相同两题。",
  "pipeline_stage": "qwen37_paid_probe",
  "question_types": [
    "multi",
    "calculation"
  ...
  "root_cause_cluster": "qwen37_runtime_compatibility_unknown",
  "status": "blocked_technical",
  "submission_effect": "technical_probe_incomplete_not_submitted",
  "target_qids": [
    "fc_b_019",
    "fc_b_001"
  ]
...
- recorded_at: `2026-07-23T15:30:41+00:00`

```json
{
  "approach": "增加decimal百分数正例和窄范围确定性类型归一化后，使用固定Qwen快照重跑相同两题。",
  "artifact_path": "artifacts/b_board_actual/qwen37_probe_fc019_fc001_v2",
  "candidate_fingerprint": {
    "components": {
      "context": {},
      "identity": {
        "change_vector": {
          "calculation_prompt": "explicit_decimal_percentage_example",
          "model": "qwen3.7-plus-2026-05-26",
          "normalization": "text_numeric_direct_output_to_decimal",
          "scope": "two_qids_same_as_failed_probe"
        },
        "domains": [
          "financial_contracts"
        ],
        "hypothesis": "明确约束qwen把数值输出变量声明为decimal，并仅对直接数值输出引用的纯数字text字面量做可审计归一化，可消除fc_b_001的重复结构失败且不改变答案数值。",
        "pipeline_stage": "qwen37_paid_probe",
        "question_types": [
          "calculation",
          "multi"
        ],
        "root_cause_cluster": "calculation_plan_numeric_value_typed_as_text",
        "target_qids": [
          "fc_b_001",
          "fc_b_019"
        ]
    ...
    "context_sha256": "44136fa355b3678a1146ad16f7e8649e94fb4fc21fe77e8310c060f61caaff8a",
    "direction_sha256": "8a5deb6f113162601269a9697950db2a89b771b4012b0a649cdc665b8fe9fd1f",
    "schema_version": 1,
    "semantic_sha256": "0b32064ed3bbf80d09b19112906b0680f1264b5bff307d799fed14dbd692b3b5",
    "sha256": "e268593044cfe6314c9985c43ca412a9040e85bdecbca65c2b89bb1c24930d31"
  },
  "change_vector": {
    "calculation_prompt": "explicit_decimal_percentage_example",
    "model": "qwen3.7-plus-2026-05-26",
  ...
  "direction_id": "qwen37_calculation_numeric_literal_normalization",
  "domains": [
    "financial_contracts"
  ],
  "effect": "未形成通过全部本地门禁的两题候选。",
  "experiment_id": "b-loop-qwen37-calculation-numeric-literal-normalization-a1",
  "failure_analysis": "{\"returncode\": 0, \"manifest_status\": \"complete\", \"failed_qids\": [], \"header\": [\"qid\", \"answer1\", \"answer2\", \"answer3\", \"answer4\", \"prompt_tokens\", \"completion_tokens\", \"total_tokens\", \"reasoning\"], \"answer_matches\": {\"fc_b_019\": true, \"fc_b_001\": true}, \"reasoning_statuses\": {\"fc_b_019\": \"supported\", \"fc_b_001\": \"supported\"}, \"calculation_grounding\": true, \"normalization_count\": 0}",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
        "context": {},
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "825860f0a1534e6d7cf21d1a69f391b03ed0a12aafc19d2b50773b06c80bae54",
      "size": 934011
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "94e781cc5e73cd596035eaa7055ee2fc1f2a7de0de304460bc87b9fd08715021",
      "size": 757647
    },
    "related_log_sections": [
      "B0-actual-evaluation",
    ...
    "reviewed_at": "2026-07-23T15:28:37+00:00"
  },
  "hypothesis": "明确约束Qwen把数值输出变量声明为decimal，并仅对直接数值输出引用的纯数字text字面量做可审计归一化，可消除fc_b_001的重复结构失败且不改变答案数值。",
  "material_delta": {
    "deterministic_normalization": true,
    "new_prompt_constraint": true
  },
  "metrics": {
  ...
  "next_step": "读取失败artifact定位新根因；技术失败不作为材料方向的有效轮次，修复后先重新审查日志。",
  "pipeline_stage": "qwen37_paid_probe",
  "question_types": [
    "calculation",
    "multi"
  ...
  "root_cause_cluster": "calculation_plan_numeric_value_typed_as_text",
  "status": "blocked_technical",
  "submission_effect": "technical_probe_only_not_submitted",
  "target_qids": [
    "fc_b_001",
    "fc_b_019"
  ]
...
- recorded_at: `2026-07-23T15:31:29+00:00`

```json
{
  "approach": "对同一v2探针产物做零新增调用的确定性复核，并追加更正上一条误分类记录：成功条件应是Qwen输出已为decimal或安全归一化后为decimal，而不是强制要求归一化次数大于零。",
  "artifact_path": "artifacts/b_board_actual/qwen37_probe_fc019_fc001_v2",
  "candidate_fingerprint": {
    "components": {
      "context": {},
  ...
  "effect": "v2实际完整成功：2/2题、九列submit.csv、submission_eligible=true、答案值匹配证据、两题reasoning均supported、fc_b_001 calculation grounding=true。Qwen已直接输出4个decimal百分数变量，因此归一化次数0是prompt约束生效，不是失败。总Token由首轮33812降至15820，减少17992（53.2119%）。",
  "experiment_id": "b-loop-qwen37-calculation-numeric-literal-normalization-a1-result-correction",
  "failure_analysis": "上一条blocked_technical来自评估包装器的假阴性门禁，不是生产链失败；错误门禁把兜底未触发误当成修复未生效。生产代码和v2产物无需重跑。两题覆盖仍有限，100题可能出现其他schema badcase。",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
        "context": {},
    ...
    "history_decision": {
      ...
      "comparable_attempt_count": 0,
      "decision": "execute",
      "reason": "The identical prior run ended in a technical failure and did not consume a comparable attempt",
      "related_experiment_ids": [
        "b-loop-qwen37-calculation-numeric-literal-normalization-a1"
      ],
      "similarity": 1.0
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "30f62ff709ce9adb28932b75ed56bd1e155f1acaf61651945f7a2848ba11cd45",
      "size": 943691
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "034c6b69b97746387407c5c81aeea52952a54ca05ee989e8254ffaefb9d85566",
      "size": 765811
    },
    "related_log_sections": [
      "B0-actual-evaluation",
    ...
    "reviewed_at": "2026-07-23T15:31:29+00:00"
  },
  "hypothesis": "明确约束Qwen把数值输出变量声明为decimal，并仅对直接数值输出引用的纯数字text字面量做可审计归一化，可消除fc_b_001的重复结构失败且不改变答案数值。",
  "material_delta": {
    "result_classification_correction": "normalization_count_zero_means_prompt_compliance"
  },
  "metrics": {
    "additional_paid_calls": 0,
    "answered_question_count": 2,
    "calculation_grounding_verified": true,
    "calculation_plan_normalization_count": 0,
    ...
    "official_accuracy": null,
    "official_submission_count": 0,
    "prior_probe_token_total": 33812,
    "prompt_tokens": 11568,
    "qwen_decimal_variable_count": 4,
    "raw_call_count": 3,
    "reasoning_grounding_statuses": {
      "fc_b_001": "supported",
      "fc_b_019": "supported"
    },
    "result_correction_only": true,
    "submission_eligible": true,
    "submission_generated": true,
    "submit_header_exact": true,
    "submit_sha256": "03756b7142b9e5f8d6c423d2efbb35de1bdf94b351dadb19f2860d920d152af4",
    "token_reduction": 17992,
    "token_reduction_percent": 53.2119,
    "token_total": 15820
  },
  "next_step": "把有效修复建独立分支、提交并推送；然后固定同一Qwen快照运行100题独立基线。",
  "pipeline_stage": "qwen37_paid_probe",
  "question_types": [
    "calculation",
    "multi"
  ...
  "root_cause_cluster": "calculation_plan_numeric_value_typed_as_text",
  "status": "completed",
  "submission_effect": "local_candidate_only_not_officially_submitted",
  "target_qids": [
    "fc_b_001",
    "fc_b_019"
  ]
...
- recorded_at: `2026-07-23T16:58:47+00:00`

```json
{
  "approach": "强化计算prompt的原始变量/派生step、通用args、literal、count、sort和增长率契约；本地仅做可证明不改变语义的schema规范化、step alias替换和输出依赖裁剪；明确schema错误重试时不扩检索。固定Qwen3.7快照复跑15道结构失败题与1道超时题。",
  "artifact_path": "artifacts/b_board_actual/qwen37_calc_structure_badcases_a1",
  "base_commit": "026b8f1bb366632eec2b534447806b1ac9d91d3a",
  "candidate_fingerprint": {
    "components": {
      "context": {
        "base_commit": "026b8f1bb366632eec2b534447806b1ac9d91d3a"
      ...
      "identity": {
        "change_vector": {
          "calculation_prompt": "qwen37_structure_contract_v1",
          "locator": "attempt_43",
          "model": "qwen3.7-plus-2026-05-26",
          "plan_normalization": "args_literal_alias_prune_count_sort",
          "structural_retry_retrieval": "skip",
          "workers": 4
        },
        "domains": [
          "financial_contracts",
        ...
        "hypothesis": "强化原始变量与派生steps边界，并对不改变语义的args、literal、alias、count和sort结构做确定性本地规范化，可提升计算badcase完成率并减少无效扩检索重试。",
        "pipeline_stage": "qwen37_calculation_planning",
        "question_types": [
          "calculation"
        ],
        "root_cause_cluster": "derived_variables_and_plan_schema_mismatch",
        "target_qids": [
          "fc_b_014",
          "fin_b_014",
          "fin_b_015",
    ...
    "context_sha256": "7cb056a696d3e2c51cc6788d99c31ec7d915066424fd392d33f3c169c76f2bc7",
    "direction_sha256": "933d0bff3761fbda24b1711140b844923922abf0c1a304c0d6df4b92ae18f5ac",
    "schema_version": 1,
    "semantic_sha256": "d22e32ff52a7c8509589d55e4381a1291cd17fcc9279c26d93d29dabdd16fbb7",
    "sha256": "34659fb6709ecdc2bf7e68082e4d9b8ffbd3c932aca1e17ce90e9b3b48c402ed"
  },
  "change_vector": {
    "calculation_prompt": "qwen37_structure_contract_v1",
    "locator": "attempt_43",
  ...
  "direction_id": "qwen37_calculation_plan_structure_contract",
  "domains": [
    "financial_contracts",
    "financial_reports",
    "insurance",
  ...
  "effect": "16道首轮失败题中Stage A完成13道、Stage B完成11道；已完成答案里9道与pseudo99参考等价、4道不同，官网答案锁回退0道。候选总生成Token为414683，旧基线同集合失败调用Token为716179。该比较只衡量本地完成率与参考保持，不是官网准确率。",
  "experiment_id": "b-loop-qwen37-calculation-plan-structure-contract-a1",
  "failure_analysis": "仍有3道答案阶段未完成、2道仅reasoning未完成。未解决答案错误簇：{'Calculation failed after 3 grounded replay attempts': 2, \"HTTPSConnectionPool(host='dashscope.aliyuncs.com', port=443)\": 1}；未解决reasoning失败2道。结构规范化命中：{'prune_non_output_dependencies': 2}；确定性结构错误跳过扩检索0次。",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
        "context": {
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "d2619730f25902e9a74aeed8dbb7192df725ab5c6b63c4601a859557b892670a",
      "size": 976477
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "b18826374458fcd15e4c0f4fc236cc0e74068c5c78509b9a3d9b4c7a7b2986e0",
      "size": 792974
    },
    "related_log_sections": [
      "b-loop-calculation_executor-a3-directional-operands-v3",
    ...
    "reviewed_at": "2026-07-23T16:43:30+00:00"
  },
  "hypothesis": "强化原始变量与派生steps边界，并对不改变语义的args、literal、alias、count和sort结构做确定性本地规范化，可提升计算badcase完成率并减少无效扩检索重试。",
  "metrics": {
    "answer_completed_count": 13,
    "baseline_target_failed_token_total": 716179,
    "candidate_generation_token_total": 414683,
    "candidate_vs_baseline_token_delta": -301496,
    "normalization_counts": {
      "prune_non_output_dependencies": 2
    },
    "official_accuracy": null,
    "official_answer_lock_regression_count": 0,
    "official_answer_lock_regressions": [],
    "official_submission_count": 0,
    "proxy_total_score": null,
    "reasoning_completed_count": 11,
    "reasoning_shadow_score": null,
    "reference_match_count": 9,
    ...
    "structural_retrieval_skip_count": 0,
    "target_question_count": 16,
    "unresolved_answer_count": 3,
    "unresolved_reasoning_count": 2
  },
  "next_step": "逐题审计剩余失败和参考差异，保持同方向但引入实质增量后进行A2；不得重复A1。",
  "pipeline_stage": "qwen37_calculation_planning",
  ...
  "root_cause_cluster": "derived_variables_and_plan_schema_mismatch",
  "status": "completed",
  "submission_effect": "local_subset_not_submitted",
  "target_qids": [
    "fc_b_014",
    "fin_b_014",
    "fin_b_015",
...
- recorded_at: `2026-07-23T17:26:11+00:00`

```json
{
  "approach": "在A1后审计7道未完成或参考差异题，补充目标期优先、全年分红组成、保险金分段保底、统一金额/人数尺度、中文整数grounding、同尺度比率单位清理和百分点结果维度门禁；固定Qwen3.7快照与attempt_43复跑，不注入pseudo99，不提交官网。",
  "artifact_path": "artifacts/b_board_actual/qwen37_calc_structure_badcases_a2",
  "base_commit": "026b8f1bb366632eec2b534447806b1ac9d91d3a",
  "candidate_fingerprint": {
    "components": {
      "context": {
      ...
      "identity": {
        "change_vector": {
          "calculation_prompt": "qwen37_structure_contract_v2_semantic",
          "locator": "attempt_43",
          "model": "qwen3.7-plus-2026-05-26",
          "plan_normalization": "a1_plus_ratio_unit_count_scale_chinese_grounding",
          "semantic_output_gate": "percentage_points",
          "semantic_retrieval": "full_year_dividend_and_conditional_benefit",
          "workers": 4
        },
        "domains": [
          "financial_reports",
        ...
        "hypothesis": "在a1结构契约基础上，补齐全年分红、保险分段保底、目标期优先、统一金额尺度和百分点维度的证据约束，可修复已定位的7道计算badcase，同时继续降低无效重试token。",
        "pipeline_stage": "qwen37_calculation_planning",
        "question_types": [
          "calculation"
        ],
    ...
    "context_sha256": "7cb056a696d3e2c51cc6788d99c31ec7d915066424fd392d33f3c169c76f2bc7",
    "direction_sha256": "bd04243e6aa26b51988d58f20af5e4129ff028d693bb90bb516e5c09e3507c79",
    "schema_version": 1,
    "semantic_sha256": "31aa9e21193513d7d453960d691a2a22c3a0843306dc8ab5527009c491d26613",
    "sha256": "315ef817959a69897785968e376265081cc168a4e7f3ac4cc45602687df5bb59"
  },
  "change_vector": {
    "calculation_prompt": "qwen37_structure_contract_v2_semantic",
    "locator": "attempt_43",
  ...
  "effect": "Stage A由同题A1的4/7提升到5/7，Stage B由2/7提升到4/7；5个冻结答案中3个与pseudo99参考等价，2个仍不同。总生成Token 179329，较A1同题184856减少5527。该结果仅说明局部完成率、参考保持与Token变化，不是官网准确率。",
  "experiment_id": "b-loop-qwen37-calculation-plan-structure-contract-a2",
  "failure_analysis": "fin_b_015仍因pct_point_delta的new/old结构漂移在3轮后失败；res_b_005为API read timeout；res_b_012答案阶段输出0.0而参考为67.1且reasoning仍insufficient；fin_b_016输出66.85而参考为76.92。预设有效门槛（至少6/7答案完成、参考差异0、答案锁回退0）未达到。",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
        "context": {
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "432afccb85a9951e5f30e72d5867938f44843683447d9a4734a58be924bfba7d",
      "size": 990865
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "6f9fc6c83657def73484d68e84021bf7af9d345390ce757597e59b3fc3a13d61",
      "size": 804560
    },
    "related_log_sections": [
      "b-loop-calculation_executor-a1-typed_grounded_calc_v2",
    ...
    "reviewed_at": "2026-07-23T17:09:36+00:00"
  },
  "hypothesis": "在A1结构契约基础上，补齐全年分红、保险分段保底、目标期优先、统一金额尺度和百分点维度的证据约束，可修复已定位的7道计算badcase，同时继续降低无效重试Token。",
  "material_delta": {
    "a1_root_causes_addressed": [
      "full_year_dividend_aggregation",
      "conditional_benefit_floor",
      "target_period_precedence",
      "amount_count_scale_consistency",
      "chinese_integer_grounding",
      "percentage_point_dimension"
    ]
  },
  "metrics": {
    "a1_same_target_generation_token_total": 184856,
    "a2_generation_token_total": 179329,
    "a2_vs_a1_token_delta": -5527,
    "answer_completed_count": 5,
    "official_accuracy": null,
    "official_answer_lock_regression_count": 0,
    "official_answer_lock_regressions": [],
    "official_submission_count": 0,
    "proxy_total_score": null,
    "reasoning_completed_count": 4,
    "reasoning_shadow_score": null,
    "reference_match_count": 3,
    "reference_matches": [
      "ins_b_018",
      "reg_b_007",
      "res_b_007"
    ],
    "reference_mismatch_count": 2,
    "reference_mismatches": [
      {
        "candidate": [
          "宁德时代>美的集团>招商银行>中国建筑",
    ...
    "unresolved_answer_qids": [
      "fin_b_015",
      "res_b_005"
    ],
    "unresolved_reasoning_qids": [
      "res_b_012"
    ]
  },
  "next_step": "不重复A2。将格式失败拆为独立qwen37_structured_output_contract方向：原生strict CalculationPlan Schema + 本地确定性硬兜底 + Schema再校验；仅不可无歧义修复时重试模型，再对同题集做对照。",
  "pipeline_stage": "qwen37_calculation_planning",
  "promotion_result": "needs_refinement",
  "question_types": [
    "calculation"
...
- recorded_at: `2026-07-23T17:32:32+00:00`

```json
{
  "approach": "先用固定Qwen3.7快照完成简单Schema与完整CalculationPlan v1两次脱敏原生strict能力探针；客户端显式区分native_json_schema_strict与json_object_local_schema且不静默降级。生产计算链采用原生strict Schema；本地仅修复value→literal、无歧义参数映射、裸数字常量、passthrough alias、无语义元数据和派生依赖，并在修复后重过Schema、grounding与Decimal重放；无法无歧义修复才重试模型，结构错误不扩检索。",
  "artifact_path": "artifacts/b_board_actual/qwen37_calc_structured_strict_a1",
  "base_commit": "026b8f1bb366632eec2b534447806b1ac9d91d3a",
  "candidate_fingerprint": {
    "components": {
      "context": {
      ...
      "identity": {
        ...
        "hypothesis": "原生strict calculationplan schema配合只做无歧义变换的本地硬兜底，并在兜底后重新校验schema，可使格式错误不再浪费证据扩检索与多轮模型重试，同时保持答案语义。",
    ...
    "context_sha256": "7cb056a696d3e2c51cc6788d99c31ec7d915066424fd392d33f3c169c76f2bc7",
    "direction_sha256": "574160bf44177c368c368f1562b45f7520e92fbcd3f4cb9be0b8cc045beb8fd5",
    "schema_version": 1,
    "semantic_sha256": "557f9e53b7b2473f71ef2cefb98ed5d18b32ce673e03d36168700d6b731dc98e",
    "sha256": "92c066428db06d6e965692b8593c5388644c752fd8f83142b6c5f8f4bd2458ee"
  },
  "change_vector": {
    "calculation_plan_schema": "calculation_plan_v1",
    "local_normalization": "qwen37_structure_contract_v3_schema",
  ...
  "effect": "能力探针2/2通过；历史45个失败计划离线有43个经硬兜底后通过Schema。真实3题对照中Stage A与Stage B均3/3，三题全部与pseudo99参考等价；fin_b_015由A2三轮格式失败转为19.75。全部5次答案调用均标记native strict，结构错误扩检索0次。三题总生成Token 70202，较旧链同题70243减少41，完成率提升且无Token代价。该结果不是官网准确率。",
  "experiment_id": "b-loop-qwen37-structured-output-contract-a1",
  "failure_analysis": "两次真实重试来自grounding缺值或单位，不是Schema格式错误，按设计允许定向扩检索。完整Schema探针completion Token偏高，当前3题总Token仅与旧链持平，尚不能证明全100题Token显著下降；离线43/45只验证结构，另外2次old/rate歧义正确保留给模型重试。",
  "history_review": {
    "candidate_fingerprint": {
      "components": {
        "context": {
    ...
    "log_snapshot": {
      "exists": true,
      "sha256": "631489bb236eb895e4492f2995d985e3e9f39b4eb0ff95552197400f30b8eacf",
      "size": 1004915
    },
    "max_comparable_attempts": 3,
    "registry_snapshot": {
      "exists": true,
      "sha256": "7c7f7bc1d40dbbcdc206d36a009ab29fe16911a59053d35941b445690474885d",
      "size": 816218
    },
    "related_log_sections": [
      "B0-actual-integrity",
    ...
    "reviewed_at": "2026-07-23T17:27:13+00:00"
  },
  "hypothesis": "原生strict CalculationPlan Schema配合只做无歧义变换的本地硬兜底，并在兜底后重新校验Schema，可使格式错误不再浪费证据扩检索与多轮模型重试，同时保持答案语义。",
  "material_delta": {
    "archived_plan_attempts_repaired_locally": "43/45",
    "capability_probes_passed": 2
  },
  "metrics": {
    "answer_completed_count": 3,
    "archived_plan_attempt_count": 45,
    "archived_plan_post_fallback_schema_valid_count": 43,
    "candidate_generation_token_total": 70202,
    "candidate_vs_prior_token_delta": -41,
    "fin_b_015_a2_failed_token_total": 34515,
    "fin_b_015_candidate_total_with_reasoning": 30110,
    "grounding_retrieval_round_count": 2,
    "native_capability_probe_pass_count": 2,
    "native_strict_answer_call_count": 5,
    "non_native_answer_call_count": 0,
    "normalization_counts": {
    ...
    "official_answer_lock_regression_count": 0,
    "official_submission_count": 0,
    "prior_same_target_generation_token_total": 70243,
    "proxy_total_score": null,
    ...
    "reference_mismatches": [],
    "structural_retry_retrieval_skip_count": 0,
    "target_question_count": 3
  },
  "next_step": "将有效实现建分支推送；随后在该分支运行100题合规基线，比较答案完成率、reference保持、reasoning完成率和完整Token，再决定是否进入reasoning质量方向。",
  "pipeline_stage": "qwen37_calculation_plan_serialization",
  "promotion_result": "effective",
  "question_types": [
    "calculation"
  ...
  "root_cause_cluster": "qwen37_calculation_plan_format_drift",
  "status": "effective",
  "submission_effect": "local_subset_not_officially_submitted",
  "supporting_artifacts": [
    "artifacts/b_board_actual/qwen37_structured_output_probe_v1/probe_result.json",
    "artifacts/b_board_actual/qwen37_structured_output_probe_v1/calculation_schema_probe_result.json",
    "artifacts/b_board_actual/qwen37_structured_output_probe_v1/offline_fallback_audit.json"
  ],
  "target_qids": [
    "fin_b_015",
    "fc_b_014",
